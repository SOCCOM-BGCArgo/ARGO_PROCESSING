function [DATA,HEADERS,NICEHEADERS]=CO2SYS_ESPER(PAR1,PAR2,PAR1TYPE,PAR2TYPE,SAL,TEMPIN,TEMPOUT,PRESIN,PRESOUT,SI,PO4,pHSCALEIN,K1K2CONSTANTS,KSO4CONSTANTS);
%**************************************************************************
%
% This is CO2SYS version 1.1 (SEPT-2011).  This ESPER version only has a
% modified filename and these comments to ensure compatibility for people
% who have different CO2SYS versions.
%
