function NO3 = calc_FLOAT_NO3_MOD250(spec, ncal,Pcor_flag)
% 
% PURPOSE:
...
%       [SDN, DarkCur,Pres,Temp,Sal,NO3,BL_B,BL_M,RMS ERROR,WL~240,ABS~240,ABS_cor,ENO3,WL,t_fit]
...
%                   and it uses a 250 nm wavelength limit for fits
...
% KJ - this uses 250 nm max wavelength
ncal.max_fit_WL = 250;
