function out=CANYON_pH(gtime,lat,lon,pres,temp,psal,doxy)
% function out=CANYON_pH(gtime,lat,lon,pres,temp,psal,doxy)
% 
% Multi-layer perceptron to predict pH (total scale at insitu PTS) 
%
...
%
% output:
% out   - pH (total scale at insitu PT)
%
% check value: 7.868775
...
temporaire=fopen([basedir 'Fichier_poids_PH_hidden_ascii19_8.sn'],'r');
...
Moy  =load([basedir 'moy_PH.dat']);
Ecart=load([basedir 'std_PH.dat']);
