...
% function out=CANYON_CT(gtime,lat,lon,pres,temp,psal,doxy)
% 
% Multi-layer perceptron to predict total CO2 / dissolved inorganic carbon
% / umol kg-1
%
...
% out   - DIC / umol kg-1
%
% check value: 2197.551 umol kg-1
...
temporaire=fopen([basedir 'Fichier_poids_CT_hidden_ascii18_15.sn'],'r');
...
Moy  =load([basedir 'moy_CT.dat']);
Ecart=load([basedir 'std_CT.dat']);
