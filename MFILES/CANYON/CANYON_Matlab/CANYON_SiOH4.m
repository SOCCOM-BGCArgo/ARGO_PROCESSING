...
%
% check value: 5.603550 umol kg-1
...
temporaire=fopen([basedir 'Fichier_poids_SI_hidden_ascii20_15.sn'],'r');
...
nc2=15; % Number of neurons of the second hidden layer
...
Moy  =load([basedir 'moy_SI.dat']);
Ecart=load([basedir 'std_SI.dat']);
