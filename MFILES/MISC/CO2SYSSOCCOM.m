function [DATA,HEADERS,NICEHEADERS]=CO2SYSSOCCOM(PAR1,PAR2,PAR1TYPE,PAR2TYPE,SAL,TEMPIN,TEMPOUT,PRESIN,PRESOUT,SI,PO4,pHSCALEIN,K1K2CONSTANTS,KSO4CONSTANTS);
...
% *SOCCOM added this line to see the magnitude of SWStoTOT, it is about
% 0.98.
%meanNaN((1 + TS./KS)./(1 + TS./KS + TF./KF));
...
% *SOCCOM commented this out- use Perez and Fraga 1987 instead as per
% Dickson e-mail 9/7/15
...
% As per an e-mail 9/7/15 Dickson says to use Perez and Fraga 1987 for KF
% *SOCCOM
