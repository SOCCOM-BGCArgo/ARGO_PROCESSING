...
%     Measurements = [adj_data(:,iS), ptemp, adj_data(:,iO)];
    ...
    LIAR_alk_str = ['TALK_LIAR = Alkalinity estimated with the LIAR V2.2 ', ...
        ...
        '(Carter et al., 2016,doi:10.1002/lom3.10087)'];
    LIAR_alk_str2 = '';
...
fprintf(fid_raw,['//Univ. of Washington ID: ',info.UW_ID_num,'\r\n']);
fprintf(fid_raw,['//MBARI ID: ',info.FloatViz_name,'\r\n']);
