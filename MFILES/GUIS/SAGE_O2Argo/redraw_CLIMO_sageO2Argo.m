 function DATA = redraw_CLIMO_sageO2Argo(dirs,gui,DATA,inputs)

% ************************************************************************
% redraw_CLIMO_sageO2Argo.m
% ************************************************************************
%
% Function to plot NCEP comparisons within the GUI.
%
%
% INPUTS:
...
%     DATA.refsub(:,4)
%     DATA.airsub{1}{1}(:,2)
    plot(DATA.airsub{1}{1}(:,2),DATA.airsub{1}{1}(:,9),'.-',...
        'color',mycolors(7,:),'Parent',gui.whichAX(1),'markersize',20,'linewidth',2); %AIRold
...
%         'color',mycolors(7,:),'Parent',gui.whichAX(1),'linewidth',2); %AIRold
    if DATA.howmanyairs >1;
        hold(gui.whichAX(1),'on')
        plot(DATA.airsub{1}{3}(:,2),DATA.airsub{1}{3}(:,9),...
