function [tableDATA,brkRESIDS] = calc_gainADJtable_sO2Argo(DATA,cyST,cyEND,is_floatQC)
% ************************************************************************
% calc_gainADJtable_sO2Argo.m
% ************************************************************************
%
...
%
%
% USE AS: [DATA.tableDATA,DATA.brkRESIDS] = calc_gainADJtable_sO2Argo(DATA,cyST,cyEND,1)
%
% INPUTS:
