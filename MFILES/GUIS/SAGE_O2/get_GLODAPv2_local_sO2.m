function d = get_GLODAPv2_local_sO2(track, tol, depth_bnds,user_dir)
% PURPOSE: 
...
%
%   LG 11/18/2024 Updated GLODAP_fn to include the latest GLODAP dataset
%                 for 2023.
...
% ***********************************************************************
if isempty(user_dir)
    user_dir = [getenv('USERPROFILE'),'\Documents\MATLAB\']; %returns user path,i.e. 'C:\Users\jplant'
end
GLODAP_dir          = [user_dir,'\ARGO_PROCESSING\', ...
                      'DATA\GLODAP\'];
%GLODAP_fn           = 'GLODAPv2 Merged Master 102716.mat';
% GLODAP_fn			= 'GLODAPv2.2021_Merged_Master_File.mat';

%LG 11/18/2024 updating dataset to GLODAP 2023
GLODAP_fn = 'GLODAPv2.2023_Merged_Master_File.mat';
