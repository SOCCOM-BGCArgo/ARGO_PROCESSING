function [gui,DATA] = apply_QCadj_sO2(gui,inputs,DATA)
% ************************************************************************
% apply_QCadj_sO2.m
% ************************************************************************
%
...
%
%
% USE AS: [gui,DATA] = apply_QCadj_sO2(gui,inputs,DATA)
%
% INPUTS:
...
% ************************************************************************
        ...
        if inputs.rorq ==1 
            ...
            if ~isempty(DATA.O2air{1}) && get(gui.rb3(2),'Value')~=1
                DATA.RAWorQCair = DATA.O2air;
                if strcmp(DATA.floatTYPE,'SOLO') %only 1 in-air flavor
                    LoopCT = 1; %only 1 in-air flavor for the solos.
                else
                    LoopCT = DATA.howmanyairs;
                end
                ...
                for  s = 1:LoopCT
                    ...
                    DATA.RAWorQCair{1}{ss}(:,7:11) = DATA.RAWorQCair{1}{ss}(:,7:11).*airGAIN;
                end
            end
